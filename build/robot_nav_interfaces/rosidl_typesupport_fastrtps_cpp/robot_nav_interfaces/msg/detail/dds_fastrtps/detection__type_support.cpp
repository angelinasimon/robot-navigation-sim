...
#include "robot_nav_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_robot_nav_interfaces
cdr_serialize(
  const robot_nav_interfaces::msg::Detection & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  robot_nav_interfaces::msg::Detection & ros_message)
{
  // Member: class_name
  cdr >> ros_message.class_name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_nav_interfaces::msg::Detection;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const robot_nav_interfaces::msg::Detection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<robot_nav_interfaces::msg::Detection *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_robot_nav_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<robot_nav_interfaces::msg::Detection>()
{
  return &robot_nav_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, robot_nav_interfaces, msg, Detection)() {
  return &robot_nav_interfaces::msg::typesupport_fastrtps_cpp::_Detection__handle;
}
