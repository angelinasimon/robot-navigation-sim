...
bool robot_nav_interfaces__msg__detection__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("robot_nav_interfaces.msg._detection.Detection", full_classname_dest, 45) == 0);
  }
  robot_nav_interfaces__msg__Detection * ros_message = _ros_message;
  {  // class_name
...
PyObject * robot_nav_interfaces__msg__detection__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("robot_nav_interfaces.msg._detection");
