...
#include "robot_nav_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
using _Detection__ros_msg_type = robot_nav_interfaces__msg__Detection;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = robot_nav_interfaces__msg__Detection;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const robot_nav_interfaces__msg__Detection * ros_message = static_cast<const robot_nav_interfaces__msg__Detection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_robot_nav_interfaces__msg__Detection(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  robot_nav_interfaces__msg__Detection * ros_message = static_cast<robot_nav_interfaces__msg__Detection *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_robot_nav_interfaces__msg__Detection(cdr, ros_message);
}

static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_robot_nav_interfaces__msg__Detection(
...
static size_t _Detection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_robot_nav_interfaces__msg__Detection(
